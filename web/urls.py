...
urlpatterns = [
    ...
    path('task/<int:id>/take/', take_task, name='take_task'),
    path('task/<int:id>/unassign/', unassign_task, name='unassign_task'),
    path("task/<int:id>/", current_task_view, name="current_task"),
    path("tasks/", task_view, name="tasks"),
    path("tasks/completed/", completed_task_view, name="completed_tasks"),
    path('move-task/', move_task, name='move_task'),
    path('column/add/', add_column, name='add_column'),
    path('column/rename/', rename_column, name='rename_column'),
